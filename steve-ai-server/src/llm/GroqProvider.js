...
export class GroqProvider extends LLMProvider {
    ...
    currentIndex = 0;
    modelName;
    constructor(model = "llama-3.2-11b-vision-preview") {
        super();
    ...
    getNextClient() {
        ...
        if (!client)
            throw new Error(`Groq client at index ${this.currentIndex} is undefined`);
    ...
    async chatWithRetry(retryCount, prompt, modelOverride, imageBuffer) {
